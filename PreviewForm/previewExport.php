      ...
      <div class="row-fluid">
        ...
        <div class="span9">
          <div class="well">
            ...
            <?php echo form_open("pages/saveexport");?>
            ...
            <b>ที่อยู่ผู่ส่ง: </b><span style="color:red"><?echo $_POST["faddress2"];?></span><br>
            ...
            <b>ที่อยู่ผู่รับ: </b><span style="color:red"><?echo $_POST["faddress3"];?></span><br>
            ...
            <? $mark = $_POST['mark']; ?>
            <b>เครื่องหมายที่สัังเกตบนหีบห่อ</b><span style="color:red"><?echo $_POST["mark"];?></span><br>
            ...
            <td>
            <?php echo form_open('pages/export/11'); ?>
